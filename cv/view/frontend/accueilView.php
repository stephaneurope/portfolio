                                                    ...
                                                    <div class="timeline-panel-container">
                                                        <div class="timeline-panel">
                                                            ...
                                                            <div class="timeline-body">
                                                                <p>Langages : CSS/HTML/JS/Php</p>
                                                                <p>Framework : Bootstrap/JQuery</p>
                                                                <p>Bonnes pratique : POO/MVC</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                   ...
                                                   <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner" role="listbox">
                                                      <div class="item active">
                                                        ...
                                                        { ?>
                                                            <div class="item ">
                                                                <a class="thumbnail" href="index.php?action=portfolio&amp;id=<?php echo $data['id'] ?>" target="portfolio" > <img src="/cv/public/images/<?php  echo $data['image'] ; ?>" alt="portfolio" class="img-responsive"> </a></div><?php  } ?>
